...
public class UrlController {
    ...
    public void redirectToFullUrl(HttpServletRequest request, HttpServletResponse response, @PathVariable String shortenString) {
        try {
            com.neueda.interview.urlshortener.model.UrlEntity urlEntity = urlService.getByShortUrl(shortenString);
            urlClickService.recordClick(urlEntity, request);
            FullUrl fullUrl = new FullUrl(urlEntity.getFullUrl());
